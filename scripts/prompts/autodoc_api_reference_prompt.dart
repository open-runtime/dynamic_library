...
/// Autodoc API_REFERENCE.md prompt generator for a Dart module.
///
/// Usage:
...
- **ClassName**: one-line description
  ...
  - Any factory constructors or named constructors

### 2. Enums
For each public enum:
- **EnumName**: what it represents
  - All values with short descriptions

### 3. Extensions
For each public extension:
- **ExtensionName** on **TargetType**: what it adds
  - Methods and getters with descriptions
...
- Do not invent fields, methods, or class names
