...
/// Autodoc QUICKSTART.md prompt generator for a Dart module.
///
/// Usage:
...
## Rules
- Use only real class, method, and field names from the source code
- Do not invent API names or import paths
